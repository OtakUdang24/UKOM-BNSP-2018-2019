                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="?page=Transaksi" class="dropdown-item">Transaksi</a>
                    ...
                    <div class="card-body">
                        <form method="GET">
                            <div class="form-group">
                                ...
                                <input type="text" required name="tgllapor" data-date-format="yyyy-mm-dd" class="form-control" id="tgl_input"
